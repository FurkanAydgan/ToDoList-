...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, Modal, Keyboard, TouchableWithoutFeedback } from 'react-native';
...
export default function Home({ navigation }) {
    ...
    return (
        ...
        <View style={globalStyles.container}>
            ...
            <MaterialIcons
                name='add' size={24} onPress={() => setModalOpen(true)}
